...
# 夜盘观察实时行情文件缓存。策略与盘前保持一致，但使用独立文件，避免
# 夜盘估值日实时行情和盘前/盘中/盘后缓存互相污染。
NIGHT_QUOTE_CACHE_TTL_MINUTES = 15
NIGHT_QUOTE_CACHE_RETENTION_DAYS = 1
NIGHT_QUOTE_CACHE_MAX_ITEMS = 500
